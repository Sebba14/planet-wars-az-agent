...
> **Update (May 2026):** The submission deadline has now passed. The competition is underway at the conference (May 25–29, Paphos, Cyprus). Results will be published on the [Live Leaderboard](https://github.com/SimonLucas/planet-wars-rts-submissions/blob/main/results/spring-2026/leaderboard.md) shortly.

---

## 🗓️ Submission Deadline

**May 18, 2026 — Anywhere on Earth** *(deadline now closed)*
